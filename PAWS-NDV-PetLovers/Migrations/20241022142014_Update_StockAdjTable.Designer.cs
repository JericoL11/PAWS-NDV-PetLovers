...
namespace PAWS_NDV_PetLovers.Migrations
{
    ...
    [Migration("20241022142014_Update_StockAdjTable")]
    partial class Update_StockAdjTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PAWS_NDV_PetLovers.Models.Records.StockAdjustment", b =>
                {
                    ...
                    b.Property<int?>("purchaseDetailsNavpurchaseDet_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("purchaseDetailsNavpurchaseDet_Id");
            ...
            modelBuilder.Entity("PAWS_NDV_PetLovers.Models.Records.StockAdjustment", b =>
                {
                    b.HasOne("PAWS_NDV_PetLovers.Models.Records.Product", "productsNav")
                        .WithOne("stockAdjustmentNav")
                        .HasForeignKey("PAWS_NDV_PetLovers.Models.Records.StockAdjustment", "productId");

                    b.HasOne("PAWS_NDV_PetLovers.Models.Transactions.PurchaseDetails", "purchaseDetailsNav")
                        .WithMany()
                        .HasForeignKey("purchaseDetailsNavpurchaseDet_Id");

                    b.Navigation("productsNav");

                    b.Navigation("purchaseDetailsNav");
                });
